...
int main () {
    ...
    if (connect(connSocketFD, (sockaddr*) &server_addr, sizeof(sockaddr_in))) {
        ...
        if(buff[0] == 'o') isX = false;
        if(isX) std::cout << "jogador é x" << std::endl;
        else{
            std::cout << "jogador é o" << std::endl;
        }
    }
    game_state s;    
    ...
    std::cout << "Dois jogadores conectados, podem começar. Primeiro joga o X e daí se alterna. Bom jogo!" << std::endl;
    ...
    while (true) {
        ...
        if(isX){
            ...
            if(cell == 9) {
                std::cout << "O oponente saiu! RAGE QUIT!!!" << std::endl;
                break;
            }
            ...
            if(cell == 9) {
                std::cout << "O oponente saiu! RAGEQUIT!!!" << std::endl;
                break;
            }
